-- Проверяем и создаем расширение pgcrypto в правильной схеме
CREATE EXTENSION IF NOT EXISTS pgcrypto SCHEMA public;

-- Исправляем функцию с правильным использованием pgcrypto
...
BEGIN
  ...
  INSERT INTO auth.users (
    ...
    'authenticated',
    admin_email,
    public.crypt(admin_password, public.gen_salt('bf')),
    now(),
